...
impl PodInfoDto {
    pub fn new(created_at: i64, error_container_statuses: Vec<models::NodePodErrorStatusDto>, images_version: std::collections::HashMap<String, String>, metrics_usage: models::MetricsUsageDto, name: String, namespace: String, restart_count: i32) -> PodInfoDto {
        PodInfoDto {
